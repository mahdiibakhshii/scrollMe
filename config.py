...
# Logic
# One steady rule for advancing the reel: the collective scroll fires only once
# at least this share of the currently-online audience have swiped this round.
AUDIENCE_PERCENTAGE_THRESHOLD = float(os.environ.get('AUDIENCE_PERCENTAGE_THRESHOLD', '0.50'))  # 50% must swipe
